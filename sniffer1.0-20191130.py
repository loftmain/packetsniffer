...
if __name__ == '__main__':
    ...
    os.mkdir(filter_option)
    os.chdir(os.getcwd()+'\\'+filter_option)
        ...
        while True:
            ...
            if IPv4type == 1 and filter_option.find('icmp') != -1:
                if len(filter_option_list) == 1:
                    print('---------------------No. {}'.format(packet_count),'---------------------')
                    print(strIpHeader, strIcmpHeader)
                    packet_inven.append('---------------------No. {}'.format(packet_count)+strIpHeader+strIcmpHeader)
                    
                else:
                    for i in range(1, len(filter_option_list)):
                        if (strIcmpHeader.find(filter_option_list[i]) != -1) or \
                           (strIpHeader.find(filter_option_list[i]) != -1):
                            filter_count += 1
            ...
            elif IPv4type == 6 and filter_option.find('http ') != -1:
                if len(filter_option_list) == 1:
                    print('---------------------No. {}'.format(packet_count),'---------------------')
                    print(strIpHeader, strTcpHeader, strHttpHeader)
                    packet_inven.append('---------------------No. {}'.format(packet_count)+strIpHeader+strTcpHeader+strHttpHeader)
                else:
                    for i in range(1, len(filter_option_list)):
                        if (strTcpHeader.find(filter_option_list[i]) != -1) or \
                           (strIpHeader.find(filter_option_list[i]) != -1)\
            ...
            elif IPv4type == 6 and filter_option.find('https') != -1:
                if len(filter_option_list) == 1:
                    print('---------------------No. {}'.format(packet_count),'---------------------')
                    print(strIpHeader, strTcpHeader, strHttpHeader)
                    packet_inven.append('---------------------No. {}'.format(packet_count)+strIpHeader+strTcpHeader+strHttpHeader)
            ...
            elif IPv4type == 17 and filter_option.find('dns') != -1:
                if len(filter_option_list) == 1:
                    print('---------------------No. {}'.format(packet_count),'---------------------')
                    print(strIpHeader, strUdpHeader, strDnsHeader)
                    packet_inven.append('---------------------No. {}'.format(packet_count)+strIpHeader+strUdpHeader+strDnsHeader)
                else:
                    for i in range(1, len(filter_option_list)):
                        if (strUdpHeader.find(filter_option_list[i]) != -1) or \
                           (strDnsHeader.find(filter_option_list[i]) != -1):
                            filter_count += 1
                    if filter_count == (len(filter_option_list) - 1):
                        print('---------------------No. {}'.format(packet_count),'---------------------')
                        print(strIpHeader, strUdpHeader, strDnsHeader)
